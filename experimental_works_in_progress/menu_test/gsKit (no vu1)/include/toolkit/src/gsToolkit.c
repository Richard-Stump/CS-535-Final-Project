...
int gsKit_texture_bmp(GSGLOBAL *gsGlobal, GSTEXTURE *Texture, const char *Path)
{
	GSBITMAP Bitmap;
	int x, y;
	int cy;
...
int  gsKit_texture_jpeg_scale(GSGLOBAL *gsGlobal, GSTEXTURE *Texture, const char *Path, bool scale_down)
{
	FILE *fp;
...
int  gsKit_texture_jpeg(GSGLOBAL *gsGlobal, GSTEXTURE *Texture, const char *Path) {
