...
namespace detail
{
	...
	struct compute_vec4_equal
	{
		...
		{
			return
				detail::compute_equal<T, std::is_floating_point<T>::value>::call(v1.x, v2.x) &&
				detail::compute_equal<T, std::is_floating_point<T>::value>::call(v1.y, v2.y) &&
				detail::compute_equal<T, std::is_floating_point<T>::value>::call(v1.z, v2.z) &&
				detail::compute_equal<T, std::is_floating_point<T>::value>::call(v1.w, v2.w);
		}
	};
