...
namespace glm
{
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'min' only accept floating-point or integer inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'max' only accept floating-point or integer inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'fmin' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'fmax' only accept floating-point inputs");
