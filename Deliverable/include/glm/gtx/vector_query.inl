...
namespace detail
{
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'areCollinear' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'areOrthogonal' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'isNormalized' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'isNull' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'isCompNull' only accept floating-point inputs");
