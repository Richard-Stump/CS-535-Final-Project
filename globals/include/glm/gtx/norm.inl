...
namespace detail
{
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<genType>::value, "'length2' accepts only floating-point inputs");
		return x * x;
	}
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'length2' accepts only floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'distance2' accepts only floating-point inputs");
