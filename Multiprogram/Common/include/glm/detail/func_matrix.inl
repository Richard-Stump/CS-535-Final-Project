...
namespace detail
{
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value || GLM_CONFIG_UNRESTRICTED_GENTYPE, "'matrixCompMult' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value || GLM_CONFIG_UNRESTRICTED_GENTYPE, "'outerProduct' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value || GLM_CONFIG_UNRESTRICTED_GENTYPE, "'transpose' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value || GLM_CONFIG_UNRESTRICTED_GENTYPE, "'determinant' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value || GLM_CONFIG_UNRESTRICTED_GENTYPE, "'inverse' only accept floating-point inputs");
