...
namespace glm
{
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<genType>::value, "'fastSqrt' only accept floating-point input");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<genType>::value, "'fastLength' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::is_floating_point<T>::value, "'fastLength' only accept floating-point inputs");
