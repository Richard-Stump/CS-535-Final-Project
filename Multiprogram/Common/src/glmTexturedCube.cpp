...
{
	VECTOR ps2_position = {position.x, position.y, position.z, position.w};
	VECTOR ps2_rotation = {rotation.x, rotation.y, rotation.z, rotation.w};

	create_local_world(local_world, ps2_position, ps2_rotation);
